...
module.exports = {
  ...
  EVENT_ERROR, EVENT_WARNING, EVENT_SOIL_MOISTURE, EVENT_DHT,
  ERROR_MESSAGE_TOO_LONG,
  REQUEST_SET_RELAY, REQUEST_SOIL_MOISTURE, REQUEST_GET_RELAY, REQUEST_TOGGLE_RELAY, REQUEST_READ_DHT
};
