...
LENGTH.EVENT.SOIL_MOISTURE.REDUNDANT = (LENGTH.PACKET_TYPE + LENGTH.SUBJECT
  + LENGTH.EVENT.SOIL_MOISTURE.SENSOR_ID + LENGTH.COMMON.SOIL_MOISTURE.MOISTURE) % 8;

LENGTH.EVENT.DHT.REDUNDANT = (LENGTH.PACKET_TYPE + LENGTH.SUBJECT
  + LENGTH.EVENT.DHT.SENSOR_ID + LENGTH.COMMON.DHT.HUMIDITY + LENGTH.COMMON.DHT.TEMPERATURE) % 8;

LENGTH.EVENT.DS18B20.REDUNDANT = (LENGTH.PACKET_TYPE + LENGTH.SUBJECT
  + LENGTH.EVENT.DS18B20.SENSOR_ID + LENGTH.COMMON.DS18B20.TEMPERATURE) % 8;
